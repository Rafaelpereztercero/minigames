...
export default {
         ...
         window.onload=function(){
            ...
            let id = document.getElementById("userdf").value
...
<template>
   ...
   <div class="grid grid-cols-8 grid-rows-[200px 300px]">
              ...
              <div
                     ...
                     <p class="col-start-5 self-center text-[2.5rem] text-[white]">Admin</p>
              ...
              <div
                ...
                <div class="h-full w-full flex items-center justify-between">
                    <label class="flex w-full justify-around text-white sm:text-[2rem] text-[0.85rem] sm:text-[1rem]" for="id">Username
                     <input id="userdf" type="text" placeholder="username to delete" class="text-black self-center rounded p-[0.4rem]">
                     <button id="delete" class="bg-black text-red-400 h-[4rem] p-[0.4rem] w-[8rem] rounded absolute">DELETE</button>
                    </label>
                    <div id="content"></div>
                    </div>
                    </div>
