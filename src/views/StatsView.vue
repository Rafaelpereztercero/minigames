...
`
setTimeout(function() {document.getElementById("test").classList.add("w-[20%]")
})}, 3000);
              ...
              <div
                     ...
                     <div
                            ...
                            <div class="p-[2rem] col-start-1 col-end-4 grid">
                                   <div id="nft"
                                          class="justify-self-center row-start-1    grid grid-cols-3 w-[16rem] h-[7rem] rounded-[20px] border-[1px]">
                                          <div class="h-[4rem] self-center ml-[30%]  justify-self-center row-start-1 w-[5rem] border-[1px] flex items-center rounded overflow-hidden">
                                                 <img class="object-cover h-[200%] w-[200%] flex justify-center items-center   overflow-hidden"
                                                        src="/star.png">
                                          </div>
                                          <div class="flex col-start-2 col-end-4 flex-col items-center justify-center ">
                                   ...
                                   class="justify-self-center row-start-1    grid grid-cols-3 w-[16rem] h-[7rem] rounded-[20px] border-[1px]">
                                          <div class="h-[4rem] self-center ml-[30%]  justify-self-center row-start-1 w-[5rem] border-[1px] flex items-center rounded overflow-hidden">
                                                 <img class="object-cover h-[100%] w-[100%] flex justify-center items-center   overflow-hidden"
                                                        src="/Gameboy.png">
                                          </div>
                                          <div class="flex col-start-2 col-end-4 flex-col items-center justify-center ">
