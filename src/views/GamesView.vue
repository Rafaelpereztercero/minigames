  ...
  <div class="grid grid-cols-8 grid-rows-[200px 300px]">
    ...
    >
      ...
      >
        <div
          id="1"
          class="grid-cols-1 grid cursor-pointer overflow-hidden h-[12rem] hover:h-[20rem] duration-[1000ms] w-[12rem]  rounded"
        >
          <img src="/mario.png" class="object-cover w-full h-full" />
          <div
            class="self-end justify-self-center w-[12rem] rounded z-50 bg-violet-600/80 text-[2rem] text-center text-white absolute"
          >
            Triqui
          </div>
        </div>
