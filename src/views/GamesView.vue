    ...
    function setImg() {
      for (var z = 1; z < 4; z++) {
        ...
        if (document.getElementById(`${celda}ra`).innerHTML != "") {
          ...
          if (
            document.getElementById(`${celda}ra`).classList.contains(`${z}f`)
          ) {
          } else {
        ...
        if (data[x]) {
          ...
          document
            ...
            .addEventListener("mouseover", function () {
              document.getElementById(
                "1a"
              ).innerHTML = `<button id="p1" class="w-[6rem] rounded  h-[4rem] text-white bg-green-400">Play</button>`;
...
<div id="start" class="cursor-pointer mt-[2rem] h-[3rem] w-[8rem] text-white bg-green-600 rounded flex justify-center align-center items-center self-center ">Start</div>
                ...
                for (var i = 1; i <= 9; i++) {
                  document
                    ...
                    .addEventListener("click", function (event) {
                      if (
                        (setWin("bg-white") && setWin("gray-600") == true) ||
                        setWin("gray-600") == "tie" ||
                        setWin("bg-white") == "tie"
                      ) {
                        return;
                      ...
                      if (
                        ...
                        event.target.classList.contains("bg-white") ||
                      ...
                      document.getElementById("player").innerHTML =
                        parseInt(document.getElementById("player").innerHTML) +
                        1;
                      if (setWin("bg-gray-600") == true) {
                        document
                          .getElementById("frScreen")
                      ...
                      while (asker == true) {
                        ...
                        if (
                          ...
                          document.getElementById("IA").innerHTML =
                            parseInt(document.getElementById("IA").innerHTML) +
                            1;
          ...
          document
            .getElementById("1")
            .addEventListener("mouseout", async function () {
          ...
          document
            ...
            .addEventListener("mouseover", function () {
              document.getElementById(
                "2a"
              ).innerHTML = `<button id="p2" class="w-[6rem] rounded  h-[4rem] text-white bg-green-400">Play</button>`;
...
<div id="start" class="cursor-pointer mt-[2rem] h-[3rem] w-[8rem] text-white bg-green-600 rounded flex justify-center align-center items-center self-center ">Start</div>
            ...
            document
              ...
              .addEventListener("click", function () {
                ...
                const timer = setInterval(() => {
                  ...
                  if (number < 10) {
                    document.getElementById("greenTimer").style.width =
                      parseInt(number) + "rem";
                  }
          ...
          document
            ...
            .addEventListener("mouseover", function () {
              document.getElementById(
                "3a"
              ).innerHTML = `<button id="p3" class="w-[6rem] rounded  h-[4rem] text-white bg-green-400">Play</button>`;
...
<div class="w-[35rem] h-[24rem] border-[1px] self-center">
          ...
          document
            ...
            .addEventListener("mouseover", function () {
              document.getElementById(
                "4a"
              ).innerHTML = `<button id="p4" class="w-[6rem] rounded  h-[4rem] text-white bg-green-400">Play</button>`;
...
<template>
  <div
    id="asideact"
    class="rounded sm:hidden content-center duration-[1000ms] fixed translate-x-[1000px] w-full z-50 h-full p-[3rem] bg-white/20"
  >
    <div class="flex rounded justify-center h-[100%] w-[100%] items-center">
      <div class="bg-white rounded h-[100%] w-[100%] flex flex-col p-[0rem]">
        <div class="flex bg-gray-900 w-[100%] p-[1rem] justify-between">
          ...
          <button
            id="close"
            class="self-end w-[3rem] h-[3rem] rounded bg-red-600 text-white"
          >
            X
          </button>
        </div>
        ...
        <div
          class="bg-violet-300 h-full p-[0rem] w-full flex flex-col items-center mt-[0rem]"
        >
          <div class="bg-violet-400 w-full flex flex-col items-center">
          

            <div
              class="bg-violet-400 h-[20%] pb-[1rem] grid grid-cols-3 w-full mt-[2rem]"
            >
              <div
                v-on:click="load('Login')"
              ...
              <img
                src=""
                class="border-[1px] justify-self-center w-[5rem] h-[5rem] rounded-full"
              />
              <div
                v-on:click="load('Register')"
          ...
          <div
            class="flex w-full flex-col justify-between items-center h-[40%]"
          >
            <div
              v-on:click="load('Home')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Home
            </div>
            <div
              v-on:click="load('Games')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Games
            </div>
            <div
              v-on:click="load('Shop')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Shop
            </div>
            <div
              v-on:click="load('Inventory')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Inventory
            </div>
            <div
              v-on:click="load('Stats')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Stats
            </div>
            <div
              v-on:click="load('Profile')"
              class="bg-violet-300 cursor-pointer text-center hover:bg-violet-700 hover:text-white w-[100%] h-[3rem] duration-[1000ms] flex justify-center items-center"
            >
              Profile
            </div>
  ...
  <div class="grid grid-cols-8 grid-rows-[200px 300px]">
    ...
    <div id="cookieAlert" class="flex">
      <div class="fixed z-[100]">
        ...
        >
          ...
          <p class="mt-[2rem]">
            Nosotros y nuestros equipos almacenamos o accedemos a información en
            un dispositivo, tales como cookies, y procesamos datos personales,
            tales como identificadores únicos e información estándar enviada por
            un dispositivo, para anuncios y contenido personalizados, medición
            de anuncios y del contenido e información sobre el público, así como
            para desarrollar y mejorar productos. Con su permiso, nosotros y
            nuestros socios podemos utilizar datos de localización geográfica
            precisa e identificación mediante las características de
            dispositivos. Puede hacer clic para otorgarnos su consentimiento a
            nosotros y a nuestros socios para que llevemos a cabo el
            procesamiento previamente descrito. De forma alternativa, puede
            acceder a información más detallada y cambiar sus preferencias antes
            de otorgar o negar su consentimiento. Tenga en cuenta que algún
            procesamiento de sus datos personales puede no requerir de su
            consentimiento, pero usted tiene el derecho de rechazar tal
            procesamiento. Sus preferencias se aplicarán solo a este sitio web.
            Puede cambiar sus preferencias en cualquier momento entrando de
            nuevo en este sitio web o visitando nuestra política de privacidad.
          </p>

          <div id="acceptCookie" class="border-[1px]">
            <input
              type="button"
              class="bg-green-700 w-[50rem] text-white p-[1rem] rounded"
              value="ACEPTO"
            />
          </div>
        </div>
    ...
    >
      ...
      v-model="game"
        type="text"
        class="cursor-pointer w-[80%] h-[2rem] text-center g-white/60 rounded"
        placeholder="Type a game"
      />
      <p>TEST V MODEL {{ game }}</p>
      <div
        class="grid grid-cols-4 w-full h-full content-around p-[4rem] bg-gray-300/20 rounded"
      >
        <div
          id="1"
