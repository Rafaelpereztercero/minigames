...
<template>
  <div class="grid grid-cols-8 grid-rows-[200px 300px]">
    ...
    >
      <form
        class="border-[1px] flex flex-col justify-around align-between text-[white] rounded h-full w-full"
      >
        <label class="flex w-full justify-around" for="mail"
          >Mail
        ...
        <label class="flex w-full justify-around" for="password"
          >Password
