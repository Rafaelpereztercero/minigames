...
<template>
     ...
     <div class="grid grid-cols-8 grid-rows-[200px 300px]">
              ...
              <div
                     ...
                     <p class="col-start-4 self-center text-[2.5rem] text-[white]">Register</p>
              ...
              <div
                     ...
                     <form class="border-[1px] flex flex-col justify-around align-between text-[white] rounded h-full w-full ">
                            ...
                            <input type="button"  v-on:click="ps()"  class=" cursor-pointer hover:text-black transition duration-800 ease-in-out hover:bg-white rounded w-[75%] self-center h-[2.5rem] bg-gray-900 text-[white]" value="Register">
                     </form>
              </div>
