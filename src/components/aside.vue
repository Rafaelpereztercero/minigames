  ...
  <div class="hidden sm:inline w-full h-full flex flex-col ">
    <div class="flex flex-no-wrap">
      ...
      <div style="min-height: 95vh" 
        ...
        <div class="mt-[3rem] h-[6rem] w-[60%] bg-gray-700 self-center rounded grid grid-cols-3 p-[1.5rem]">
