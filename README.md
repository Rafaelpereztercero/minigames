...
#### In this website iv optimazed a punch of images but for me the best ones are the svg images Which have their own custom path!
...
### I have implemented an auth service based on cookies, what this system does is assiging a cookie to the user if the credentials are correct

![image]https://cdn.discordapp.com/attachments/1052648248894038127/1076938938339573902/image.png
...
## In this project iv learned the basics about view (routing,views,modules ...) and as i have previously documented, my project follows all the steps required
